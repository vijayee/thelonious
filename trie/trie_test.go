...
func TestEmptyTrie(t *testing.T) {
	trie := NewEmpty()
	res := trie.Hash()
	exp := crypto.Sha3(thelutil.Encode(""))
...
func TestInsert(t *testing.T) {
	...
	exp := thelutil.Hex2Bytes("8aad789dff2f538bca5d8ea56e8abe10f4c7ba3a5dea95fea4cd6e7c3a1168d3")
	root := trie.Hash()
	...
	exp = thelutil.Hex2Bytes("d23786fb4a010da3ce639d66d5e904a11dbc02746d1ce25029e53290cabf28ab")
	root = trie.Hash()
	if !bytes.Equal(root, exp) {
		t.Errorf("exp %x got %x", exp, root)
	}
...
func TestDelete(t *testing.T) {
	...
	hash := trie.Hash()
	exp := thelutil.Hex2Bytes("5991bb8c6514148a29db676a14ac506cd2cd5775ace63c30a4fe457715e9ac84")
...
func TestReset(t *testing.T) {
	...
	before := thelutil.CopyBytes(trie.roothash)
	...
	trie.Reset()
	after := thelutil.CopyBytes(trie.roothash)
