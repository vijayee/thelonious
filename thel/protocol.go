...
func (self *ethProtocol) handle() error {
	...
	case GetBlockHashesMsg:
		...
		return p2p.EncodeMsg(self.rw, BlockHashesMsg, thelutil.ByteSliceToInterface(hashes)...)
...
func (self *ethProtocol) requestBlocks(hashes [][]byte) error {
	...
	return p2p.EncodeMsg(self.rw, GetBlocksMsg, thelutil.ByteSliceToInterface(hashes)...)
}
