...
func (tm *TestManager) Reactor() *monkreact.ReactorEngine {
	return tm.reactor
}
func (tm *TestManager) Broadcast(msgType monkwire.MsgType, data []interface{}) {
	fmt.Println("Broadcast not implemented")
}

func (tm *TestManager) ClientIdentity() monkwire.ClientIdentity {
	return nil
}
func (tm *TestManager) KeyManager() *monkcrypto.KeyManager {
	return nil
}

func (tm *TestManager) Db() monkutil.Database { return nil }

func NewTestManager() *TestManager {
	monkutil.ReadConfig(".monktest", "/tmp/monktest", "ETH")
